...
package com.janak.androidnetworking.gsonparserfactory;
...
final class GsonRequestBodyParser<T> implements Parser<T, RequestBody> {
    ...
    private static final Charset UTF_8 = Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT ? StandardCharsets.UTF_8 : Charset.forName("UTF-8");
