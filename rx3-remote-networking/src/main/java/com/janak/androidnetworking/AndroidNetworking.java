...
import com.janak.androidnetworking.common.ConnectionQuality;
import com.janak.androidnetworking.core.Core;
import com.janak.androidnetworking.interceptors.HttpLoggingInterceptor.Level;
import com.janak.androidnetworking.interfaces.ConnectionQualityChangeListener;
import com.janak.androidnetworking.interfaces.Parser;
import com.janak.androidnetworking.internal.ANImageLoader;
    ...
    public static void initialize(Context context, OkHttpClient okHttpClient) {
        if (okHttpClient != null && okHttpClient.cache() == null) {
            okHttpClient = okHttpClient
                    .newBuilder()
                    .cache(Utils.getCache(context.getApplicationContext(), ANConstants.MAX_CACHE_SIZE, ANConstants.CACHE_DIR_NAME))
                    .build();
        }
