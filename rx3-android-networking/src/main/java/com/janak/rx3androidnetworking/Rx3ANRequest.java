...
public class Rx3ANRequest extends ANRequest<Rx3ANRequest> {

    public Rx3ANRequest(GetRequestBuilder builder) {
        super(builder);
    }

    public Rx3ANRequest(PostRequestBuilder builder) {
        super(builder);
    }

    public Rx3ANRequest(DownloadBuilder builder) {
        super(builder);
    }

    public Rx3ANRequest(MultiPartBuilder builder) {
        super(builder);
    }
    ...
    public Observable<JSONObject> getJSONObjectObservable() {
        ...
        if (this.getRequestType() == RequestType.SIMPLE) {
            return Rx3InternalNetworking.generateSimpleObservable(this);
        } else if (this.getRequestType() == RequestType.MULTIPART) {
            return Rx3InternalNetworking.generateMultipartObservable(this);
        } else {
            return null;
        }
    }
    ...
    public Observable<String> getDownloadObservable() {
        return Rx3InternalNetworking.generateDownloadObservable(this);
    }
    ...
    public static class GetRequestBuilder extends ANRequest.GetRequestBuilder<GetRequestBuilder> {
        ...
        public Rx3ANRequest build() {
            return new Rx3ANRequest(this);
        }
    }
